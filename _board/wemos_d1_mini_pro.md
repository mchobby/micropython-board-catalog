...
---
layout: download
board_id: "wemos_d1_mini_pro"
title: "Wemos/LOLIN D1 Mini Pro Download"
name: "Wemos D1 Mini Pro"
manufacturer: "Wemos"
board_url: "https://www.wemos.cc/en/latest/d1/d1_mini_pro.html"
board_image: "wemos_d1_mini_pro.jpg"
...
* A deep-sleep jumper
* A LDO regulator Enable Pin
* A jumper to measure the battery voltage on the A0
* An internal antenna + a uFl connector for external antenne
...
This ESP8266 plateform brings 16 Mbytes Flash and a CH340G USB to serial converter (as used by Sparkfun for some of their product). As the USB-to-Serial converter handles the DTR and RTS signal, there is no need for extra button to handle the bootloading activation on GPIO0 :-)
...
* [Wemos.cc](https://www.wemos.cc/en/latest/d1/d1_mini_pro.html)
